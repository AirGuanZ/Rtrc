...
RC<GraphicsPipeline> PipelineManager::CreateGraphicsPipeline(const GraphicsPipeline::Desc &desc)
{
    ...
    return graphicsPipelinePool_.GetOrCreate(key, [&]
    {
...
{
    return computePipelinePool_.GetOrCreate(shader->GetUniqueID(), [&]
    {
...
void PipelineManager::GC()
{
    graphicsPipelinePool_.GC();
    computePipelinePool_.GC();
}
