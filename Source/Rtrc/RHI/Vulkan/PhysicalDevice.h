...
public:
    ...
    static VulkanPhysicalDevice Select(VkInstance instance, const DeviceDescription &desc);

    static std::vector<const char*> GetRequiredExtensions(const DeviceDescription &desc);
